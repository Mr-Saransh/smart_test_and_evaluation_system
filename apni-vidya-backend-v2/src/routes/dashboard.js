...
router.get('/teacher/:institute_id?', authenticate, authorize('teacher', 'institute_admin'), dashboard.teacherDashboard);
router.get('/admin/:institute_id', authenticate, authorize('institute_admin', 'superadmin'), dashboard.adminDashboard);
